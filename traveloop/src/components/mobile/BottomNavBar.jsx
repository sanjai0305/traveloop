...
const NAV_ITEMS = [
  ...
  { id: "trips",    label: "Trips",    icon: Map,     path: "/my-trips" },
  { id: "new",      label: "Create",   icon: Plus,    path: "/create-trip", isFab: true },
  { id: "activity", label: "Explore",  icon: Compass, path: "/activities" },
