...
// ─── QUICK ACTIONS ────────────────────────────────────────────────────────────
const QUICK_ACTIONS = [
  { label: "My Trips",   emoji: "✈️",  path: "/my-trips",    color: "#14B8B5", bg: "rgba(20,184,181,0.1)"  },
  { label: "Create",     emoji: "➕",  path: "/create-trip", color: "#8B5CF6", bg: "rgba(139,92,246,0.1)"  },
  { label: "Packing",    emoji: "🧳",  path: "/my-trips",    color: "#F59E0B", bg: "rgba(245,158,11,0.1)"  },
  { label: "Notes",      emoji: "📝",  path: "/my-trips",    color: "#EF4444", bg: "rgba(239,68,68,0.1)"   },
];
        ...
        <div className="px-4 pt-5 pb-4">
          ...
          >
            ...
            {upcoming > 0 && (
              ...
              >
                You have{" "}
                <span className="text-teal-600 font-bold">{upcoming} trip{upcoming > 1 ? "s" : ""}</span>{" "}
                coming up 🌍
              </motion.p>
            )}
          </motion.div>
        ...
        >
          <div className="flex items-center gap-3 px-4 py-3.5 rounded-[18px] bg-white border border-slate-200 shadow-sm focus-within:border-teal-400 focus-within:ring-4 focus-within:ring-teal-50 transition-all duration-200">
            ...
            <input
              ...
              placeholder="Explore: type a city to discover attractions..."
              ...
              <div className="flex items-center justify-between px-4 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[17px] font-bold text-slate-800">
                    Near <span className="text-teal-600">{exploreQuery}</span>
                  </h3>
          ...
          <div className="grid grid-cols-4 gap-3">
            {QUICK_ACTIONS.map((action, i) => (
              ...
              >
                ...
                <span className="text-[11px] font-semibold text-slate-500">{action.label}</span>
              </motion.button>
            ))}
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between px-4 mb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[17px] font-bold text-slate-800">Trending Activities</h3>
            </div>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between px-4 mb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[17px] font-bold text-slate-800">Trending Now</h3>
            </div>
          </div>
          <div className="flex gap-2 overflow-x-auto px-4 pb-1 hide-scrollbar">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between px-4 mb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[17px] font-bold text-slate-800">Recommended For You</h3>
            </div>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between px-4 mb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[17px] font-bold text-slate-800">Continue Planning</h3>
              </div>
              <button
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-x-2.5 gap-y-1 mt-2 text-[10px] font-bold text-slate-400" style={{overflow:'hidden'}}>
                          {days && <span className="flex-shrink-0">🗓️ {days} days</span>}
                          {daysRemaining > 0 && <span className="flex-shrink-0">⏳ {daysRemaining} days left</span>}
                          {totalSpent > 0 && <span className="text-teal-600 flex-shrink-0">💰 ₹{totalSpent.toLocaleString()} spent</span>}
                          {trip.activitiesCount > 0 && <span className="text-indigo-500 flex-shrink-0">📍 {trip.activitiesCount} acts</span>}
                        </div>
                      </div>
